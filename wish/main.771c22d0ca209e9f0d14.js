! function(e) { var t = {};
    ...
    */
    ...
    n.r(t), t.default = n.p + "afc604b72643d749c042732460bb925b.png" }, function(e, t, n) { "use strict";
    ...
    class ne extends a.Component { constructor(e) { super(e), this.state = { characterBanner: this.props.getFormattedCharacterEventWish("kebabCase"), language: "English" }, this.banners = { "ballad-in-goblets": "Ballad In Goblets", "sparkling-steps": "Sparkling Steps", "gentry-of-hermitage": "Gentry Of Hermitage", "farewell-of-snezhnaya": "Farewell of Snezhnaya", "secretum-secretorum": "Secretum Secretorum", "adrift-in-the-harbor": "Adrift in the Harbor", "invitation-to-mundane-life": "Invitation to Mundane Life", "dance-of-lanterns": "Dance Of Lanterns", "moment-of-bloom": "Moment Of Bloom" }, this.onChange = this.onChange.bind(this) } onChange({ target: { name: e, value: t } }) { this.setState({
