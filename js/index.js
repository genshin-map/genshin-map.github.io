...
var LayerMap = {
    ...
    Layer_DWQ_MD: L.markerClusterGroup({ maxClusterRadius: 0 }),
    Layer_DWQ_LY: L.markerClusterGroup({ maxClusterRadius: 0 }),
    ...
    Layer_FHYS: L.markerClusterGroup({ maxClusterRadius: 0 }),
    ...
    Layer_SX_MD: L.markerClusterGroup({ maxClusterRadius: 0 }),
    Layer_SX_LY: L.markerClusterGroup({ maxClusterRadius: 0 }),
    Layer_CSD_MD: L.markerClusterGroup({ maxClusterRadius: 0 }),
    Layer_CSD_LY: L.markerClusterGroup({ maxClusterRadius: 0 }),
    Layer_MJ_MD: L.markerClusterGroup({ maxClusterRadius: 0 }),
    Layer_MJ_LY: L.markerClusterGroup({ maxClusterRadius: 0 }),
    Layer_FB_MD: L.markerClusterGroup({ maxClusterRadius: 0 }),
    Layer_FB_LY: L.markerClusterGroup({ maxClusterRadius: 0 }),
}
...
var typearray = [
    ...
    [LayerMap["Layer_FHYS"], JS_FHYS, "TC", 'FHYS'],
